  ...
  return (
    <>
      <motion.section
        ...
        className="pointer-events-none relative flex h-screen snap-start flex-col overflow-hidden px-6 after:mb-4 after:h-1 after:w-full after:rounded-full after:bg-orange md:my-12 md:px-12 md:after:mb-12 lg:px-16"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.5, delay: 0.8 }}
        className="relative mt-6 flex h-screen snap-start flex-col overflow-hidden px-6 after:mb-4 after:h-1 after:w-full after:rounded-full after:bg-orange md:my-12 md:px-12 md:after:mb-12 lg:px-16"
      >
