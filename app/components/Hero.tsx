...
const Hero: React.FC<HeroProps> = ({ data }) => {
  ...
  return (
    <motion.section
      ...
      className="pointer-events-none relative flex h-screen snap-start flex-col overflow-x-hidden px-6 after:mb-4 after:h-1 after:w-full after:rounded-full after:bg-orange md:px-12 md:after:mb-12 lg:px-16"
    >
